    ...
    public static class ServiceRegistration
    {
        public static void AddIdentityInfrastructure(this IServiceCollection services, IConfiguration config)
        {
            ...
            if (config.GetValue<bool>("UseInMemoryDatabase"))
            {
                ...
                services.AddDbContext<InternalUserContext>(options => options.UseInMemoryDatabase("CustomerDB"));
            ...
            services.AddIdentityCore<InternalUser>()
                .AddEntityFrameworkStores<InternalUserContext>().AddDefaultTokenProviders();
